...
namespace WizardGrenade2
{
    public class MenuArrows
    {
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            _arrowRPosition = new Vector2(ScreenSettings.TARGET_WIDTH - _arrow.GetSpriteRectangle().Width - INSET, INSET);
            _textYOffset = _arrow.GetSpriteRectangle().Height + 4;
        }

        public void Draw(SpriteBatch spriteBatch, bool canGoBack)
        {
            if (canGoBack)
            {
